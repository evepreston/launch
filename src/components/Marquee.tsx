  ...
  return (
    <div className="relative z-10 w-full overflow-hidden border-y border-[#e6ddc9] bg-white/60 py-3">
      <div className="flex whitespace-nowrap marquee-track">
        <span className="px-4 text-sm font-medium text-[#6b8a64] lowercase tracking-wide">
          {MARQUEE_TEXT.repeat(4)}
        </span>
        <span className="px-4 text-sm font-medium text-[#6b8a64] lowercase tracking-wide" aria-hidden>
          {MARQUEE_TEXT.repeat(4)}
        </span>
      </div>
    </div>
